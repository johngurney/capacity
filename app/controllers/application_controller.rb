class ApplicationController < ActionController::Base
  ...
  before_action :check_admin_or_observer, only: [:show, :search_aois, :history, :selected_history, :history_all, :set_allow_cheat_logon, :select_groups]
  ...
  def check_admin_or_observer
    if logged_in_user_helper.present? && !logged_in_user_helper.is_admin_or_observer? && check_if_admins_exist?
      redirect_to root_path
      false
    end
